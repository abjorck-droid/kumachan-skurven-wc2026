...
def seed_side_games():
    ...
    rows = [
        ...
        {"name": "First Red Card", "resolution_type": "team", "base_points": 30,
         "description": "Name the team whose player is shown the first red card of the tournament."},
        {"name": "First Own Goal", "resolution_type": "team", "base_points": 40,
         "description": "Name the team whose player scores the first own goal."},
